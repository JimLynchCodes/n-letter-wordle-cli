...
const binp = path.join(cargoDir, "bin", "n-letter-wordle");

if (fs.existsSync(binp)) {
  console.log("Uninstalling n-letter-wordle...");
  exec(`cargo uninstall n-letter-wordle`, (error, stdout, stderr) => {
    console.log(stdout);
    if (error || stderr) {
  ...
  console.log("n-letter-wordle not found skipping!");
}
